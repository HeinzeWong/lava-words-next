export const FAQList = {
  FAQ_EN: [
    {
      "question": "What is the purpose of the vocabulary app?",
      "answer": "The purpose of our vocabulary app is to help students enhance their vocabulary by learning new words daily through a structured and engaging platform. The app is designed to make learning new words easy, interactive, and effective."
    },
    {
      "question": "How does the vocabulary app work?",
      "answer": "The vocabulary app works by presenting a set number of new words each day for the user to learn. Each word comes with definitions, example sentences, and pronunciation guides. Users can test their knowledge through quizzes and track their progress over time."
    },
    {
      "question": "Who can benefit from using this vocabulary app?",
      "answer": "Our vocabulary app is beneficial for learners of all ages who are looking to expand their vocabulary, including students preparing for exams, professionals enhancing their communication skills, or anyone interested in learning English or improving their language proficiency."
    },
    {
      "question": "Is there a fee to use the vocabulary app?",
      "answer": "The basic version of our vocabulary app is free to use, which includes daily vocabulary exercises and quizzes. We also offer a premium version with additional features such as advanced tracking, personalized word lists, and ad-free learning experience, available via subscription."
    },
    {
      "question": "Can I track my progress in the app?",
      "answer": "Yes, the app includes a feature that allows you to monitor your learning progress. You can view the number of new words learned, quiz scores, and other statistics to see how much you have improved over time."
    },
    {
      "question": "How do I get started with the vocabulary app?",
      "answer": "Getting started is simple. Download the app from the App Store or Google Play, create an account, and start learning. The app will guide you through setting up your daily word learning goals and provide you with personalized word lists based on your level."
    },
    {
      "question": "Does the vocabulary app support multiple languages?",
      "answer": "Currently, our vocabulary app primarily focuses on English language learning. However, we are planning to add support for other languages in the future as part of our expansion."
    },
    {
      "question": "Can I suggest new features or improvements for the app?",
      "answer": "Absolutely! We value user feedback and encourage you to submit any suggestions or ideas for new features or improvements through the feedback section in the app or by contacting our support team directly."
    },
    {
      "question": "What should I do if I encounter problems with the app?",
      "answer": "If you encounter any issues while using the app, please contact our support team via email at support@vocabularyapp.com. We are here to help resolve any problems and ensure you have a smooth learning experience."
    },
    {
      "question": "Is the vocabulary app suitable for children?",
      "answer": "Yes, the vocabulary app is designed to be family-friendly and is suitable for children with appropriate parental guidance. It offers a safe and educational environment for children to expand their vocabulary."
    }
  ],

  FAQ_ZH: [
    {
      "question": "这个词汇学习应用的目的是什么？",
      "answer": "我们的词汇学习应用旨在通过一个结构化且富有吸引力的平台，帮助学生每天学习新单词，从而增强他们的词汇量。该应用旨在使学习新单词变得简单、互动和有效。"
    },
    {
      "question": "词汇学习应用如何工作？",
      "answer": "词汇学习应用通过每天展示一定数量的新单词来工作。每个单词都配有定义、例句和发音指南。用户可以通过测验测试他们的知识，并随时间跟踪他们的进度。"
    },
    {
      "question": "谁能从这款词汇应用中受益？",
      "answer": "我们的词汇应用对所有希望扩展词汇量的学习者都有益，包括准备考试的学生、希望提高沟通技能的专业人士，或任何有兴趣学习英语或改善其语言能力的人。"
    },
    {
      "question": "使用这个词汇应用需要付费吗？",
      "answer": "我们的词汇应用的基础版本是免费的，包括每日词汇练习和测验。我们还提供额外功能的高级版，如高级跟踪、个性化单词列表和无广告学习体验，可通过订阅获得。"
    },
    {
      "question": "我可以在应用中跟踪我的学习进度吗？",
      "answer": "是的，该应用包含了一个功能，允许您监控您的学习进展。您可以查看学习新单词的数量、测验成绩等统计数据，看到您随时间的进步。"
    },
    {
      "question": "我如何开始使用词汇应用？",
      "answer": "开始使用非常简单。从App Store或Google Play下载应用程序，创建账户，然后开始学习。应用将引导您设置每日学单词的目标，并根据您的水平为您提供个性化的单词列表。"
    },
    {
      "question": "词汇应用支持多种语言吗？",
      "answer": "目前，我们的词汇应用主要专注于英语学习。然而，我们计划在未来作为扩展的一部分添加对其他语言的支持。"
    },
    {
      "question": "我可以为应用提出新功能或改进建议吗？",
      "answer": "当然可以！我们非常重视用户反馈，鼓励您通过应用中的反馈部分或直接联系我们的支持团队提交任何新功能或改进的建议。"
    },
    {
      "question": "如果我在使用应用时遇到问题该怎么办？",
      "answer": "如果您在使用应用时遇到任何问题，请通过电子邮件support@vocabularyapp.com联系我们的支持团队。我们在这里帮助解决任何问题，确保您有一个顺畅的学习体验。"
    },
    {
      "question": "词汇应用适合儿童使用吗？",
      "answer": "是的，词汇应用程序专为家庭友好而设计，适合在家长适当指导下使用的儿童。它为孩子们提供了一个安全且具有教育意义的环境来扩大他们的词汇量。"
    }
  ],
  ...
  FAQ_ID: [
    {
      "question": "Apa tujuan dari aplikasi kosa kata?",
      "answer": "Tujuan dari aplikasi kosa kata kami adalah untuk membantu siswa meningkatkan kosa kata mereka dengan mempelajari kata-kata baru setiap hari melalui platform yang terstruktur dan menarik. Aplikasi ini dirancang untuk membuat pembelajaran kata baru menjadi mudah, interaktif, dan efektif."
    },
    {
      "question": "Bagaimana cara kerja aplikasi kosa kata?",
      "answer": "Aplikasi kosa kata bekerja dengan menyajikan sejumlah kata baru setiap hari untuk dipelajari oleh pengguna. Setiap kata disertai dengan definisi, contoh kalimat, dan panduan pengucapan. Pengguna dapat menguji pengetahuan mereka melalui kuis dan melacak kemajuan mereka dari waktu ke waktu."
    },
    {
      "question": "Siapa yang dapat diuntungkan dari menggunakan aplikasi kosa kata ini?",
      "answer": "Aplikasi kosa kata kami bermanfaat bagi peserta didik dari semua usia yang ingin memperluas kosa kata mereka, termasuk siswa yang mempersiapkan ujian, profesional yang meningkatkan keterampilan komunikasi mereka, atau siapa saja yang tertarik belajar bahasa Inggris atau meningkatkan kemahiran bahasa mereka."
    },
    {
      "question": "Apakah ada biaya untuk menggunakan aplikasi kosa kata?",
      "answer": "Versi dasar dari aplikasi kosa kata kami gratis untuk digunakan, yang mencakup latihan kosa kata harian dan kuis. Kami juga menawarkan versi premium dengan fitur tambahan seperti pelacakan lanjutan, daftar kata pribadi, dan pengalaman belajar tanpa iklan, tersedia melalui langganan."
    },
    {
      "question": "Apakah saya bisa melacak kemajuan saya dalam aplikasi?",
      "answer": "Ya, aplikasi ini mencakup fitur yang memungkinkan Anda untuk memonitor kemajuan belajar Anda. Anda dapat melihat jumlah kata baru yang dipelajari, skor kuis, dan statistik lainnya untuk melihat seberapa banyak Anda telah meningkat dari waktu ke waktu."
    },
    {
      "question": "Bagaimana cara saya memulai dengan aplikasi kosa kata?",
      "answer": "Memulai sangat sederhana. Unduh aplikasi dari App Store atau Google Play, buat akun, dan mulai belajar. Aplikasi akan memandu Anda dalam menetapkan tujuan belajar kata harian Anda dan menyediakan daftar kata yang dipersonalisasi berdasarkan level Anda."
    },
    {
      "question": "Apakah aplikasi kosa kata mendukung beberapa bahasa?",
      "answer": "Saat ini, aplikasi kosa kata kami terutama fokus pada pembelajaran bahasa Inggris. Namun, kami berencana untuk menambahkan dukungan untuk bahasa lain di masa depan sebagai bagian dari ekspansi kami."
    },
    {
      "question": "Dapatkah saya menyarankan fitur baru atau perbaikan untuk aplikasi?",
      "answer": "Tentu saja! Kami menghargai umpan balik pengguna dan mendorong Anda untuk mengirimkan saran atau ide untuk fitur baru atau perbaikan melalui bagian umpan balik dalam aplikasi atau dengan menghubungi tim dukungan kami secara langsung."
    },
    {
      "question": "Apa yang harus saya lakukan jika saya mengalami masalah dengan aplikasi?",
      "answer": "Jika Anda mengalami masalah saat menggunakan aplikasi, silakan hubungi tim dukungan kami melalui email di support@vocabularyapp.com. Kami di sini untuk membantu menyelesaikan masalah apa pun dan memastikan Anda memiliki pengalaman belajar yang lancar."
    },
    {
      "question": "Apakah aplikasi kosa kata cocok untuk anak-anak?",
      "answer": "Ya, aplikasi kosa kata dirancang untuk ramah keluarga dan cocok untuk anak-anak dengan bimbingan orang tua yang sesuai. Ini menawarkan lingkungan yang aman dan edukatif bagi anak-anak untuk memperluas kosa kata mereka."
    }
  ],
};
